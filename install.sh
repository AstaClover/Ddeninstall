...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='digitaldenar.conf'
CONFIGFOLDER='/root/.super8'
COIN_DAEMON='digitaldenard'
COIN_CLI='digitaldenar-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/AstaClover/Ddeninstall/releases/download/daemon/daemon.tar.gz'
...
addnode=167.71.71.97
addnode=188.166.18.13
addnode=157.245.76.233
addnode=128.199.62.97
EOF
}
